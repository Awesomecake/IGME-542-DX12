...
MeshRaytracingData RayTracing::CreateBottomLevelAccelerationStructureForMesh(Mesh* mesh)
{
	...
	geometryDesc.Triangles.VertexCount = static_cast<UINT>(mesh->GetIndexCount());
	...
	vertexSRVDesc.Buffer.NumElements = (UINT)((mesh->GetIndexCount() * sizeof(Vertex)) / sizeof(float)); // How many floats total?
